...
namespace Tests.Api.AppSession
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            /***  Para los errores  ***/
            services.LoadValidations(options => options.WithEnabled());

            /***  Para autenticar  ***/
            services.LoadSecurity(sec =>
                sec.WithAuthentication(auth =>
                    auth.WithJsonWebToken(options => options
                        .WithEnabled()
                        .WithIncludeErrorDetails()
                        .WithSaveToken()
            ...
            services.LoadSession(options => options
                .WithEnabled()
                .WithMultitenancy()
                .WithTenants(
                    new TenantSession
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            /***  Agregamos el middleware de errores  ***/
            app.LoadValidations();
